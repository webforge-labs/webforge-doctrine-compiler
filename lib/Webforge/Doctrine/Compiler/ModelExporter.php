 ...
 * Because in the generate() method from Generator we do a lot of model-expanding stuff that has nothing to do
 * with generation itself (or maybe named wrong)
 */
class ModelExporter
{
    /**
     ...
     *
     * expanded in the way that entities have additional informations that are implcit included in the model.json
